...
public final class UClass {
	...
	public static <T> @NotNull Class<T> arrayComponentType(T @NotNull [] array) {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static <T> @NotNull Class<T> arrayComponentType(T @NotNull [] @NotNull [] array) {
		UAssert.paramNotNull(array, "T[][] array");
		return (Class<T>) multiDimensionalArrayComponentType(array);
	}
	...
	public static @NotNull Stack<Class<?>> classTree(
		@NotNull Class<?> cls,
		@Range(from = -1, to = Integer.MAX_VALUE) int maxDepth
	) {
		...
		// Perform an iteration until at least one of the conditions is fulfilled.
	 ...
	 * @return a stack containing the classes in the inheritance tree, with the top being the input class
	 */
	public static @NotNull Stack<Class<?>> classTree(@NotNull Class<?> cls) {
	 ...
	 */
	public static boolean isPrimitiveType(@NotNull Class<?> cls, boolean includeWrapperTypes) {
		UAssert.paramNotNull(cls, "Class<?> cls");
	 ...
	 * @return true if the class is a primitive type, false otherwise
	 */
	public static boolean isPrimitiveType(@NotNull Class<?> cls) {
	 ...
	 * @return the component type of the array
	 */
	public static @NotNull Class<?> multiDimensionalArrayComponentType(@NotNull Object array) {
	 ...
	 */
	public static Class<?> @NotNull [] varargTypes(Object @NotNull ... args) {
	 ...
	 */
	public static Class<?> @NotNull [] varargTypesNotNull(Object @NotNull ... args) {
		UAssert.paramNotNull(args, "Object[] args");
		return Arrays.stream(args)
